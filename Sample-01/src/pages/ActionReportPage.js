...
function ActionReportPage() {
    ...
    const getClients = async () => {
        try {
            ...
            console.log("response from calling: ", response)
      ...
      const getActions = async () => {
        try {
          ...
          const response = await axios(config);
        //   setDeployedActions(response.data.result.actions);
    ...
    const checkAccessToActionReport = async () => {
        ...
        let config = {
          ...
          headers: { 
            'Accept': 'application/json', 
            'Authorization': `Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6IlJhVnNWZVB1bFVIenpQWFUwUWtvNSJ9..PH7qWfeXLe3-oas5Y0l8vtXtqiLQxF8PhDQ_JnRe-Y1In2sLcDVotCXcuwYBYm5UV5NUVfbOBkrgrRX6Cx_eaNvoj8X9ezW-wp7vPih79PUOQQJx3oEYGFKpf2zEB1pfrKbnKlatAFf2gKZZ4wsO4OIXR77YRyaVHho3m_JdMZoGD5zVQDaA5guYHMdqsihxaaS1kQzb9HPPcURGfmUQxptRd-KGL5EDY-cFhwixkDESSvZSXHh2Xl5i7EIwc8BAE8EfmxsRjC9LQq0DWTFcZzCQHJgqyNCkjL3iWclVkUAalBLuuT4da-TzVfXcJWJ1XvS9sgAcyG8OBcMREvoi7w`
            // 'Authorization': `Bearer ${token}`
          }
        };
    ...
    const getActionList = async () => {
        ...
        // console.log("clients from getActionList: ", clientList)
        // console.log("actions from getActionList: ", actions)
    ...
    // if(user && !isManager){
        return (
            <Fragment>
                <div>
                    {/* <button className='btn' onClick={() => getClients()}>Get Clients</button> */}
                    {/* <button className='btn' onClick={() => getActions()}>Get Actions</button> */}
                    {/* <button className='btn' onClick={() => getRole()}>Get Current User Role</button> */}
                </div>
